...
export const SvelteIcon = ({ size = 16 }: { size?: number }) => (
...
export const FigmaIcon = ({ size = 16 }: { size?: number }) => (
    ...
    <svg width={size} height={size} viewBox="0 0 300 300">
        <g stroke="#000" strokeWidth="38.009">
            <g id="svgstar-docs" transform="translate(150 150)">
                <path id="svgbar-docs" fill="#ffb13b" d="M-84.149-15.851a22.417 22.417 0 1 0 0 31.702H84.15a22.417 22.417 0 1 0 0-31.702Z" />
                <use href="#svgbar-docs" transform="rotate(45)" />
                <use href="#svgbar-docs" transform="rotate(90)" />
                <use href="#svgbar-docs" transform="rotate(135)" />
            </g>
        </g>
        <use href="#svgstar-docs" />
    </svg>
);
...
export const AstroIcon = ({ size = 16 }: { size?: number }) => (
    <svg width={size * (85 / 107)} height={size} viewBox="0 0 85 107" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <defs>
            <linearGradient id="astro-flame-docs" x1="22.47" x2="69.145" y1="107" y2="84.947" gradientUnits="userSpaceOnUse">
