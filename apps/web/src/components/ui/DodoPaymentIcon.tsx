interface DodoPaymentIconProps {
  size?: number;
  className?: string;
}

export default function DodoPaymentIcon({ size = 20, className = '' }: DodoPaymentIconProps) {
  return (
    <svg
      width={size}
      height={size}
    ...
    <mask id="a" width="91" height="76" x="18" y="27" maskUnits="userSpaceOnUse" style={{ maskType: 'luminance' }}>
