  ...
  return (
    <>
      ...
      <SyntaxBlock
        ...
        onCopy={() => onCopy(`---\nimport { Home, ShieldCheck, AltArrowDown } from 'reicon-astro';\n---\n\n<Home size={24} />\n<ShieldCheck size={32} color="#9B8AFB" />\n<AltArrowDown weight="Filled" />`, 'astro-basic')}
        copied={copiedField === 'astro-basic'}
      >
        ...
        {'\n'}
        <span className="text-text-base/70">{'<'}</span><span className="text-[#e06c75]">ShieldCheck</span><span className="text-[#d19a66]"> size</span><span className="text-text-base/50">=</span><span className="text-text-base/70">{'{'}32{'}'}</span><span className="text-[#d19a66]"> color</span><span className="text-text-base/50">=</span><span className="text-[#98c379]">"#9B8AFB"</span><span className="text-text-base/70"> /{'>'}</span>
        {'\n'}
