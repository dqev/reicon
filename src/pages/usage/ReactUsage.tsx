...
export default function ReactUsage({ copiedField, onCopy }: Props) {
  return (
    <section id="react-usage" data-section className="mb-16 scroll-mt-24">
      ...
      <div className="flex items-center gap-2 mb-6">
        ...
        <div>
          <h2 className="text-2xl font-serif text-white">Usage of Reicon React</h2>
        </div>
      </div>
      ...
      <p className="text-white/60 text-[15px] leading-[1.8] mb-4">
        Import icons by their PascalCase name from <code className="text-white/70 bg-white/[0.06] px-1.5 py-0.5 rounded text-[12px]">reicon-react</code>. Each icon is a React component that accepts standard props.
      </p>
      ...
      >
        ...
        {'\n      '}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">Home</span><span className="text-[#d19a66]"> size</span><span className="text-white/50">=</span><span className="text-white/70">{'{'}24{'}'}</span><span className="text-white/70"> /{'>'}</span>
        {'\n      '}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">ShieldCheck</span><span className="text-[#d19a66]"> size</span><span className="text-white/50">=</span><span className="text-white/70">{'{'}24{'}'}</span><span className="text-[#d19a66]"> color</span><span className="text-white/50">=</span><span className="text-[#98c379]">"#6C5CE7"</span><span className="text-white/70"> /{'>'}</span>
        {'\n      '}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">Bell</span><span className="text-[#d19a66]"> size</span><span className="text-white/50">=</span><span className="text-white/70">{'{'}24{'}'}</span><span className="text-[#d19a66]"> weight</span><span className="text-white/50">=</span><span className="text-[#98c379]">"Filled"</span><span className="text-white/70"> /{'>'}</span>
        {'\n    '}
        <span className="text-white/70">{'</'}</span><span className="text-[#e06c75]">div</span><span className="text-white/70">{'>'}</span>
        {'\n  '}
        <span className="text-white/70">);</span>
      ...
      >
        ...
        {'\n'}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">Home</span><span className="text-[#d19a66]"> size</span><span className="text-white/50">=</span><span className="text-white/70">{'{'}16{'}'}</span><span className="text-white/70"> /{'>'}</span>
        {'\n'}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">Home</span><span className="text-[#d19a66]"> size</span><span className="text-white/50">=</span><span className="text-white/70">{'{'}24{'}'}</span><span className="text-white/70"> /{'>'}</span>
        {'\n'}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">Home</span><span className="text-[#d19a66]"> size</span><span className="text-white/50">=</span><span className="text-white/70">{'{'}32{'}'}</span><span className="text-white/70"> /{'>'}</span>
        {'\n\n'}
        ...
        {'\n\n'}
        <span className="text-white/30">{'// ClassName'}</span>
        {'\n'}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">Home</span><span className="text-[#d19a66]"> className</span><span className="text-white/50">=</span><span className="text-[#98c379]">"text-blue-500 hover:text-blue-600"</span><span className="text-white/70"> /{'>'}</span>
      </SyntaxBlock>
      ...
      >
        <span className="text-[#c678dd]">import</span><span className="text-[#e5c07b]"> Home</span><span className="text-[#c678dd]"> from</span><span className="text-[#98c379]"> 'reicon-react/icons/Home'</span><span className="text-white/30">;</span>
        {'\n'}
        <span className="text-[#c678dd]">import</span><span className="text-[#e5c07b]"> ShieldCheck</span><span className="text-[#c678dd]"> from</span><span className="text-[#98c379]"> 'reicon-react/icons/ShieldCheck'</span><span className="text-white/30">;</span>
      </SyntaxBlock>

      <div className="mt-4 bg-[#6C5CE7]/5 border border-[#6C5CE7]/15 rounded-xl p-4 text-[13px] text-white/50 leading-relaxed">
      ...
      <h3 className="text-lg font-serif text-white mb-4 mt-10">Using with Tailwind CSS</h3>
      <p className="text-white/60 text-[15px] leading-[1.8] mb-4">
        Reicon works seamlessly with Tailwind CSS. Use the <code className="text-white/70 bg-white/[0.06] px-1.5 py-0.5 rounded text-[12px]">className</code> prop to apply Tailwind utilities. The icon inherits <code className="text-white/70 bg-white/[0.06] px-1.5 py-0.5 rounded text-[12px]">currentColor</code> by default, so Tailwind's text color classes work out of the box.
      </p>
      ...
      >
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">Home</span><span className="text-[#d19a66]"> className</span><span className="text-white/50">=</span><span className="text-[#98c379]">"text-gray-500 hover:text-gray-700 w-6 h-6 transition-colors"</span><span className="text-white/70"> /{'>'}</span>
        {'\n\n'}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">button</span><span className="text-[#d19a66]"> className</span><span className="text-white/50">=</span><span className="text-[#98c379]">"flex items-center gap-2 text-white"</span><span className="text-white/70">{'>'}</span>
        {'\n  '}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">ShieldCheck</span><span className="text-[#d19a66]"> size</span><span className="text-white/50">=</span><span className="text-white/70">{'{'}20{'}'}</span><span className="text-[#d19a66]"> className</span><span className="text-white/50">=</span><span className="text-[#98c379]">"text-green-500"</span><span className="text-white/70"> /{'>'}</span>
        {'\n  '}
      ...
      <h3 className="text-lg font-serif text-white mb-4 mt-10">Full Component Example</h3>
      <p className="text-white/60 text-[15px] leading-[1.8] mb-4">
      ...
      >
        ...
        <span className="text-[#e5c07b]">Bell</span><span className="text-white/70">, </span>
        <span className="text-[#e5c07b]">User</span><span className="text-white/70">, </span>
        <span className="text-[#e5c07b]">Star</span><span className="text-white/70">, </span>
        <span className="text-[#e5c07b]">ShieldCheck</span>
        <span className="text-white/70">{' } '}</span>
        <span className="text-[#c678dd]">from</span>
        <span className="text-[#98c379]"> 'reicon-react'</span><span className="text-white/30">;</span>
        {'\n\n'}
        <span className="text-[#c678dd]">export default function</span><span className="text-[#61afef]"> Navbar</span><span className="text-white/70">() {'{'}</span>
        {'\n  '}
        <span className="text-[#c678dd]">return</span><span className="text-white/70"> (</span>
        {'\n    '}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">nav</span><span className="text-[#d19a66]"> className</span><span className="text-white/50">=</span><span className="text-[#98c379]">"flex items-center gap-4 p-4"</span><span className="text-white/70">{'>'}</span>
        {'\n      '}
        ...
        {'\n      '}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">User</span><span className="text-[#d19a66]"> size</span><span className="text-white/50">=</span><span className="text-white/70">{'{'}20{'}'}</span><span className="text-white/70"> /{'>'}</span>
        {'\n      '}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">Star</span><span className="text-[#d19a66]"> size</span><span className="text-white/50">=</span><span className="text-white/70">{'{'}20{'}'}</span><span className="text-[#d19a66]"> weight</span><span className="text-white/50">=</span><span className="text-[#98c379]">"Filled"</span><span className="text-[#d19a66]"> color</span><span className="text-white/50">=</span><span className="text-[#98c379]">"#f59e0b"</span><span className="text-white/70"> /{'>'}</span>
        {'\n      '}
        <span className="text-white/70">{'<'}</span><span className="text-[#e06c75]">ShieldCheck</span><span className="text-[#d19a66]"> size</span><span className="text-white/50">=</span><span className="text-white/70">{'{'}20{'}'}</span><span className="text-[#d19a66]"> color</span><span className="text-white/50">=</span><span className="text-[#98c379]">"#6C5CE7"</span><span className="text-white/70"> /{'>'}</span>
        {'\n    '}
      ...
      <div className="mt-6 bg-[#61DAFB]/5 border border-[#61DAFB]/15 rounded-xl p-4 text-[13px] text-white/50 leading-relaxed">
