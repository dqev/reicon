...
export default function Troubleshooting({ markdownContent, copiedField, onCopy }: Props) {
  return (
    <section id="troubleshooting" data-section className="mb-16 scroll-mt-24">
      ...
      {/* Item 1 */}
      <h3 className="text-lg font-serif text-text-base mb-4 mt-10">Icons are not rendering (CDN)</h3>
      <p className="text-text-base/60 text-[15px] leading-[1.8] mb-4">
        Make sure the CDN script is loaded before any <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">{'<re-icon>'}</code> elements. Place the script tag in your <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">{'<head>'}</code> or before your markup.
      </p>
      <SyntaxBlock
        title="Fix"
      ...
      {/* Item 2 */}
      <h3 className="text-lg font-serif text-text-base mb-4 mt-10">Wrong icon weight showing</h3>
      <p className="text-text-base/60 text-[15px] leading-[1.8] mb-4">
        The <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">weight</code> prop is case-sensitive in the React/Vue packages. Use <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">"Outline"</code> or <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">"Filled"</code> (PascalCase). In the CDN, use lowercase: <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">"outline"</code> or <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">"filled"</code>.
      </p>
      <SyntaxBlock
        title="Fix"
      ...
      {/* Item 3 */}
      <h3 className="text-lg font-serif text-text-base mb-4 mt-10">Icons look blurry or wrong size</h3>
      <p className="text-text-base/60 text-[15px] leading-[1.8] mb-4">
        The <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">size</code> prop accepts a number (pixels). Don't pass units like "24px" — just pass the number. For the CDN, pass the number as a string attribute.
      </p>
      <SyntaxBlock
        title="Fix"
      ...
      <h3 className="text-lg font-serif text-text-base mb-4 mt-10">TypeScript can't find icon names</h3>
      <p className="text-text-base/60 text-[15px] leading-[1.8] mb-4">
        Make sure you're importing from the correct package depending on your environment (e.g. <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">"reicon"</code> for vanilla JS or <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">"reicon-react"</code> for React). Both packages ship with full type definitions. If autocomplete isn't working, restart your TypeScript server.
      </p>
      <SyntaxBlock
        title="Fix"
      ...
      {/* Item 5 */}
      <h3 className="text-lg font-serif text-text-base mb-4 mt-10">Bundle size is too large</h3>
      <p className="text-text-base/60 text-[15px] leading-[1.8] mb-4">
      ...
      {/* Item 6 */}
      <h3 className="text-lg font-serif text-text-base mb-4 mt-10">Icon color not changing</h3>
      <p className="text-text-base/60 text-[15px] leading-[1.8] mb-4">
        Icons use <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">currentColor</code> by default. If you set a <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">color</code> prop, it overrides inheritance. Check that no parent CSS is overriding the color. For Tailwind, use <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">text-*</code> utilities on the icon's <code className="text-text-base/70 bg-text-base/6 px-1.5 py-0.5 rounded text-[12px]">className</code>.
      </p>
      <SyntaxBlock
        title="Fix"
