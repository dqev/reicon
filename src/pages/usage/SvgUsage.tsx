...
export default function SvgUsage({ markdownContent, copiedField, onCopy }: Props) {
  return (
    <section id="svg-usage" className="mb-16 scroll-mt-24">
      <SectionHeader
        id="svg-usage"
        title="Usage of Reicon Raw SVGs & Assets"
        level="h2"
      ...
      <div className="mt-8 border-b border-white/[0.06] pb-4">
        <h3 className="text-xl font-serif text-white mb-2">1. Download ZIP Archive</h3>
      ...
      <div className="bg-white/[0.03] rounded-2xl p-6 border border-white/[0.04] mb-8">
        <h4 className="text-white font-medium text-[15px] mb-3">Complete SVG Assets Pack:</h4>
        ...
        <a
          ...
          download
          className="inline-flex items-center gap-2 bg-[#6C5CE7] hover:bg-[#5A4BD1] text-white text-[13px] font-semibold px-4 py-2.5 rounded-lg transition-colors"
        >
          <FiDownload size={15} />
      ...
      <div className="mt-10 mb-6 border-b border-white/[0.06] pb-4">
        <h3 className="text-xl font-serif text-white mb-2">2. Embedding in HTML</h3>
        <p className="text-white/60 text-[15px] leading-[1.8]">
      ...
      <div className="space-y-6">
        <div>
          <h4 className="text-md font-medium text-white mb-3">Outline Style Integration:</h4>
          <SyntaxBlock
          ...
          >
            ...
            {'\n  '}
            <span className="text-white/40">{'<!-- Icon stroke paths -->'}</span>
            {'\n'}
            <span className="text-[#e06c75]">{`</svg>`}</span>
          </SyntaxBlock>
        </div>
        ...
        <div>
          <h4 className="text-md font-medium text-white mb-3">Filled Style Integration:</h4>
          <SyntaxBlock
      ...
      <div className="mt-12 mb-6 border-b border-white/[0.06] pb-4">
        <h3 className="text-xl font-serif text-white mb-2">3. Dynamic Styling via CSS</h3>
        <p className="text-white/60 text-[15px] leading-[1.8]">
      ...
      <div className="bg-white/[0.03] rounded-2xl p-6 border border-white/[0.04] space-y-4">
