...
export default function VscodeUsage({ markdownContent, copiedField, onCopy }: Props) {
  return (
    <section id="vscode" className="mb-16 scroll-mt-24">
      <SectionHeader
        id="vscode"
        title="Usage of Reicon VS Code Extension"
        level="h2"
      ...
      <div className="bg-white/[0.03] rounded-2xl p-6 border border-white/[0.04] mb-8">
        <h4 className="text-white font-medium text-[15px] mb-3">Install via Editor Panel:</h4>
        ...
        >
          ...
          <span className="text-white/70"> --install-extension DevChauhan.reicon</span>
        </SyntaxBlock>
      </div>

      <div className="mt-10 mb-6 border-b border-white/[0.06] pb-4">
        <h3 className="text-xl font-serif text-white mb-2">2. Workflow & Sidebar Panel</h3>
        <p className="text-white/60 text-[15px] leading-[1.8]">
      ...
      <div className="space-y-6 text-[14px] text-white/50 leading-relaxed">
        <div className="flex gap-4">
          ...
          <div>
            <h4 className="text-white font-medium mb-1">Open the Sidebar Explorer</h4>
        ...
        <div className="flex gap-4">
          ...
          <div>
            <h4 className="text-white font-medium mb-1">Select Code Snippet Format</h4>
        ...
        <div className="flex gap-4">
          ...
          <div>
            <h4 className="text-white font-medium mb-1">Set Size and Color</h4>
        ...
        <div className="flex gap-4">
          ...
          <div>
            <h4 className="text-white font-medium mb-1">Click to Insert</h4>
