...
export default function App() {
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center overflow-x-hidden">
      ...
      <main className="relative z-10 w-full max-w-2xl px-6 py-20 flex flex-col items-center text-center gap-10">
        {/* HERO */}
        ...
        {/* FEATURES */}
        <div className="flex flex-wrap gap-2.5 justify-center fade-in d3">
        ...
        {/* FORM / STATUS */}
        <div className="w-full max-w-md flex flex-col items-center gap-3.5 fade-in d4">
        ...
        {/* FOOTER */}
        <footer className="mt-16 flex flex-col items-center gap-3 text-white/20 text-[12.5px] tracking-wide fade-in d5">
